...
<head>
    <title><?php echo "HOTEL JARS - " . $nama; ?></title>
    <meta charset="utf-8">
        ...
        <div id="invoice">
            ...
            <div class="invoice overflow-auto">
                <div style="min-width: 600px">
                        ...
                        <div class="row">
                            <div class="col">
                                <a target="_blank" href="">
                                    <img src="montana-master/img/banner/logo.jpeg" class="rounded-circle" alt="" width="100" height="100">
                                </a>
                            </div>
                            <div class="col company-details">
                                ...
                                <div>Indonesia</div>
                                <div>+62 813-8727-2994</div>
                                <div>jarshotel@gmail.com</div>
                            </div>
                        </div>
                    </header>
                    <main>
                    ...
                    <footer>
                        Bukti pemesanan kamar Jars - Indonesia.
                    </footer>
                </div>
